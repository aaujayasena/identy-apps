...
export declare class AppConstants {
     ...
     * @default
     */
    static readonly DEFAULT_APP_CONFIG_FILE_NAME: string;
    /**
     ...
     * @default
     */
    static readonly APP_CONFIG_FETCH_ERROR_MESSAGE: string;
    /**
     ...
     * @default
     */
    static readonly CONSOLE_APP: string;
    /**
     ...
     * @default
     */
    static readonly MY_ACCOUNT_APP: string;
}
