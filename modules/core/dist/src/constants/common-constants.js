 ...
 * @default
 */
CommonConstants.AXIOS_FETCH_REQUEST_ERROR_MESSAGE = "An error occurred while executing the request";
/**
 ...
 * @type {string}
 */
CommonConstants.SESSION_TIMEOUT_WARNING_URL_SEARCH_PARAM_KEY = "session_timeout_warning";
