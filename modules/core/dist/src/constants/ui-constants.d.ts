...
export declare class UIConstants {
     ...
     * @type {string}
     */
    static readonly GRAVATAR_URL: string;
    /**
     * Constant to handle the default dashboard layout's desktop content top spacing.
     * @constant
     * @type {number}
     */
    static readonly DEFAULT_DASHBOARD_LAYOUT_DESKTOP_CONTENT_TOP_SPACING: number;
    /**
     * Constant to handle the default side panel item height.
     * @constant
     * @type {number}
     */
    static readonly DEFAULT_SIDE_PANEL_ITEM_HEIGHT: number;
    /**
     * Error message to be shown in the alerting component on API retrieval errors.
     * @constant
     * @type {string}
     */
    static readonly API_RETRIEVAL_ERROR_ALERT_MESSAGE: string;
}
