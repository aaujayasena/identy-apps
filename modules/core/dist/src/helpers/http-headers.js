 ...
 */
export const HTTPRequestHeaders = (clientHost, accept = AcceptHeaderValues.APP_JSON, contentType = ContentTypeHeaderValues.APP_JSON) => {
    const headers = {
        "Accept": accept,
    ...
    return Object.keys(headers).reduce((acc, key) => ((headers[key] === undefined || headers[key] === null)
        ? acc
        : Object.assign(Object.assign({}, acc), { [key]: headers[key] })), {});
};
