 ...
 * under the License.
 */
import { SetDeploymentConfigsActionInterface, SetFeatureConfigsActionInterface, SetI18nConfigsActionInterface, SetServiceResourceEndpointsActionInterface, SetUIConfigsActionInterface } from "./types";
/**
 ...
 */
export declare const setDeploymentConfigs: <T>(configs: T) => SetDeploymentConfigsActionInterface<T>;
/**
 ...
 */
export declare const setServiceResourceEndpoints: <T>(endpoints: T) => SetServiceResourceEndpointsActionInterface<T>;
/**
 ...
 */
export declare const setFeatureConfigs: <T>(configs: T) => SetFeatureConfigsActionInterface<T>;
/**
 ...
 */
export declare const setI18nConfigs: <T>(configs: T) => SetI18nConfigsActionInterface<T>;
/**
 ...
 */
export declare const setUIConfigs: <T>(configs: T) => SetUIConfigsActionInterface<T>;
