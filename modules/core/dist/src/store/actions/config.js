 ...
 * under the License.
 */
import { CommonConfigActionTypes } from "./types";
/**
 ...
 */
export const setDeploymentConfigs = (configs) => ({
    payload: configs,
 ...
 */
export const setServiceResourceEndpoints = (endpoints) => ({
    payload: endpoints,
 ...
 */
export const setFeatureConfigs = (configs) => ({
    payload: configs,
 ...
 */
export const setI18nConfigs = (configs) => ({
    payload: configs,
 ...
 */
export const setUIConfigs = (configs) => ({
    payload: configs,
