 ...
 * under the License.
 */
import { CommonProfileActionTypes } from "./types";
/**
 ...
 */
export const setSCIMSchemas = (schemas) => ({
    payload: schemas,
 ...
 * @return {SetProfileSchemasActionInterface<T>}
 */
export const setProfileLinkedAccounts = (accounts) => ({
    payload: accounts,
 ...
 */
export const toggleSCIMEnabled = (isEnabled) => ({
    payload: isEnabled,
