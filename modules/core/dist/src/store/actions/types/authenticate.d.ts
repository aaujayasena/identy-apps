 ...
 * @enum {string}
 */
export declare enum CommonAuthenticateActionTypes {
    /**
 ...
 */
export declare type CommonAuthenticateActions<T> = ResetAuthenticationActionInterface | SetSignInActionInterface<T> | SetSignOutActionInterface | SetInitializedActionInterface;
export {};
