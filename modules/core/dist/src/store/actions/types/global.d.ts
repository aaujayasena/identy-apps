 ...
 */
export declare enum CommonGlobalActionTypes {
    /**
 ...
 */
export declare type CommonGlobalActions<T, S, U> = ShowAJAXTopLoadingBarAction | HideAJAXTopLoadingBarAction | AddAlertAction<T> | InitializeAlertSystemAction<S> | SetSupportedI18nLanguagesActionInterface<U>;
export {};
