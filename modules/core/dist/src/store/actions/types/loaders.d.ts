 ...
 * @enum {string}
 */
export declare enum CommonRequestLoadersActionTypes {
    /**
 ...
 */
export declare type CommonRequestLoadersActions = SetProfileInfoRequestLoadingStatusActionInterface | SetProfileSchemaRequestLoadingStatusActionInterface | SetTokenRequestLoadingStatusActionInterface | SetSignOutRequestLoadingStatusActionInterface | SetTokenRevokeRequestLoadingStatusActionInterface;
export {};
