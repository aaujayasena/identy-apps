 ...
 * @enum {string}
 */
export declare enum CommonProfileActionTypes {
    /**
 ...
 */
export declare type CommonProfileActions<T, S, U> = SetProfileInfoActionInterface<T> | SetProfileSchemasActionInterface<S> | SetProfileLinkedAccountsActionInterface<U> | ToggleSCIMEnabledActionInterface;
export {};
