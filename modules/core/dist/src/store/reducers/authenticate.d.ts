 ...
 * under the License.
 */
import { CommonAuthenticateActions } from "../actions/types";
/**
 ...
 */
export declare const commonAuthenticateReducer: <T, S>(initialState: T) => (state: T, action: CommonAuthenticateActions<S>) => T;
