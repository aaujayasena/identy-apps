...
export class CertificateManagementUtils {
     ...
     */
    static decodeCertificate(pem) {
        const pemValue = pem === null || pem === void 0 ? void 0 : pem.split("\n");
        // appends -----END CERTIFICATE-----.
        pemValue === null || pemValue === void 0 ? void 0 : pemValue.push(CertificateManagementConstants.CERTIFICATE_END);
        // appends a new line.
        pemValue === null || pemValue === void 0 ? void 0 : pemValue.push(CertificateManagementConstants.END_LINE);
        // pushes -----BEGIN CERTIFICATE----- to the top.
        pemValue === null || pemValue === void 0 ? void 0 : pemValue.unshift(CertificateManagementConstants.CERTIFICATE_BEGIN);
        const pemCert = pemValue === null || pemValue === void 0 ? void 0 : pemValue.join("\n");
        try {
     ...
     */
    static displayCertificate(certificate = null, pem) {
     ...
     */
    static decodeForgeCertificate(data, certificateForge) {
        return {
            alias: data.alias,
            issuerDN: certificateForge.issuer.attributes
                .map(attribute => {
     ...
     * @param issuerDN
     */
    static searchIssuerDNAlias(issuerDN) {
        let issuerAlias = "";
        issuerDN.map((issuer) => {
     ...
     * @param {string} pem The PEM encoded certificate content.
     */
    static exportCertificate(name, pem) {
...
//# sourceMappingURL=certificate-management-utils.js.map