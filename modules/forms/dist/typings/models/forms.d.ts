 ...
 * Form Field Types
 */
export declare type Type = "email" | "text" | "textarea" | "password" | "number" | "submit" | "radio" | "dropdown" | "checkbox" | "reset" | "button" | "divider" | "custom" | "toggle";
/**
 ...
 * FormField types
 */
export declare type FormField = TextField | PasswordField | FormSubmit | RadioField | DropdownField | CheckboxField | Reset | FormButton | FormDivider | CustomField | ToggleField | QueryParamsField;
/**
 * FormField value types
 */
export declare type FormValue = string | string[];
export {};
