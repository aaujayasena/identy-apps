...
exports.myAccount = {
    components: {
        ...
        changePassword: {
            ...
            modals: {
                confirmationModal: {
                    ...
                    message: "La modification du mot de passe entraînera la fin de la session en cours. Vous devrez " +
        ...
        consentManagement: {
            editConsent: {
                ...
                description: "Description",
                piiCategoryHeading: "Gérez le consentement pour la collecte et le partage de vos informations personnelles " +
            ...
            modals: {
                consentRevokeModal: {
                    ...
                    message: "Cette opération est irréversible. Cela révoquera définitivement le consentement pour tous les " +
        ...
        userSessions: {
            ...
            modals: {
                terminateAllUserSessionsModal: {
                    heading: "Confirmation",
                    message: "Cette action supprimera l'accès à votre compte depuis tous les appareils. " +
                        "Souhaitez-vous continuer ?"
                },
                terminateUserSessionModal: {
                    heading: "Confirmation",
                    message: "Cette action supprimera l'accès à votre compte depuis cet appareil. " +
                        "Souhaitez-vous continuer ?"
                }
            },
            notifications: {
    ...
    sections: {
        accountRecovery: {
            description: "Configurez les paramètres de récupération de votre compte " +
        ...
        consentManagement: {
            ...
            description: "Révoquer un consentement ou une information personnelle que vous avez accepté de partager.",
        ...
        mfa: {
            description: "Renforcez la protection de votre compte en configurant plusieurs " +
