...
exports.myAccount = {
            ...
            fido: {
                ...
                modals: {
                    deviceRegistrationErrorModal: {
                        description: "උපාංග ලියාපදිංචිය බාධා විය. මෙය හිතාමතා නොකළේ නම්, ඔබට එම ප්‍රවාහය නැවත උත්සාහ කළ " +
                ...
                notifications: {
                    ...
                    startFidoFlow: {
                        ...
                        success: {
                            description: "උපාංගය සාර්ථකව ලියාපදිංචි කර ඇති අතර දැන් ඔබට එය සත්‍යාපන සාධකයක් ලෙස භාවිතා කළ හැකිය",
    ...
    pages: {
        ...
        personalInfo: {
            subTitle: "වඩාත් පෞද්ගලික අත්දැකීමක් ලබා ගැනීම සඳහා ඔබේ පුද්ගලික තොරතුරු, සම්බන්ධිත ගිණුම් සහ " +
    ...
    sections: {
        accountRecovery: {
            description: "ඔබගේ මුරපදය හෝ පරිශීලක නාමය ඔබට අමතක වුවහොත් විද්‍යුත් තැපෑලක්, " +
        ...
        changePassword: {
            ...
            description: "ඔබගේ මුරපදය නිතිපතා යාවත්කාලීන කර එය ඔබ භාවිතා කරන වෙනත් " +
        ...
        mfa: {
            description: "සත්‍යාපන පියවර කිහිපයක් වින්‍යාස කිරීමෙන් ඔබගේ ගිණුමට අමතර ආරක්ෂිත තට්ටුවක් " +
                "එක් කරන්න. ඔබට SMS OTP, FIDO වැනි විකල්ප වලින් තෝරා ගත හැකිය.",
            heading: "බහු සාධක සත්‍යාපනය"
        },
        profile: {
            description: "නම, ඊමේල්, ජංගම දුරකථන අංකය, සංවිධානය වැනි ඔබගේ පුද්ගලික තොරතුරු " +
