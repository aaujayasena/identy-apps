...
export const TopLoadingBar = (props) => {
    const { height, visibility, ["data-testid"]: testId } = props;
    ...
    return (React.createElement(LoadingBar, { className: "app-top-loading-bar", onRef: (ref) => setLoaderRef(ref), height: height, "data-testid": testId }));
};
/**
...
//# sourceMappingURL=top-loading-bar.js.map