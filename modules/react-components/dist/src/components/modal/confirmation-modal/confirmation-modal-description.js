 ...
 */
export const ConfirmationModalDescription = (props) => {
    const { children, ["data-testid"]: testId } = props, rest = __rest(props, ["children", "data-testid"]);
    return (React.createElement(Modal.Description, Object.assign({ "data-testid": testId }, rest), children));
};
/**
...
//# sourceMappingURL=confirmation-modal-description.js.map