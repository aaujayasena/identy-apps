 ...
 */
export const DataTableHeaderCell = (props) => {
    const { children, className } = props, rest = __rest(props, ["children", "className"]);
    const classes = classNames("data-table-header-cell", className);
    return (React.createElement(Table.HeaderCell, Object.assign({ className: classes }, rest), children));
};
/**
...
//# sourceMappingURL=data-table-header-cell.js.map