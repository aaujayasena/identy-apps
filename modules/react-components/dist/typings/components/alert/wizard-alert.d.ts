 ...
 */
declare type UseWizardAlertHookReturnType = [WizardAlert, React.Dispatch<React.SetStateAction<WizardAlert>>, ReactElement];
/**
 ...
 */
export declare const useWizardAlert: () => UseWizardAlertHookReturnType;
export {};
