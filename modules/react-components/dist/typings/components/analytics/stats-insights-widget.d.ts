 ...
 */
interface StatsInsightsWidgetPropsInterface extends TestableComponentInterface {
    /**
 ...
 */
export declare const StatsInsightsWidget: FunctionComponent<PropsWithChildren<StatsInsightsWidgetPropsInterface>>;
export {};
