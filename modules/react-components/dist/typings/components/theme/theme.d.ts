...
import { ThemeContextInterface, ThemeContextStateInterface } from "./models";
/**
 * ThemeContext.
 */
 ...
 */
export declare const ThemeProvider: FunctionComponent<PropsWithChildren<ThemeProviderProsInterface>>;
export {};
