...
export declare class HttpClient implements HttpClientInterface<HttpRequestConfig, HttpResponse, HttpError> {
     ...
     */
    requestHandler(request: HttpRequestConfig): HttpRequestConfig;
    /**
     ...
     */
    init(isHandlerEnabled: boolean, requestStartCallback: (request: HttpRequestConfig) => void, requestSuccessCallback: (response: HttpResponse) => void, requestErrorCallback: (error: HttpError) => void, requestFinishCallback: () => void): void;
    /**
     * Enables the handler.
     */
    enableHandler(): void;
