...
export interface HttpClientInterface<T, U, V> {
    init(isHandlerEnabled: boolean, requestStartCallback: () => void, requestSuccessCallback: (response: U) => void, requestErrorCallback: (error: V) => void, requestFinishCallback: () => void): void;
    disableHandler: () => void;
