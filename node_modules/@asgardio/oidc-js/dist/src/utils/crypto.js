...
export const getJWKForTheIdToken = (jwtHeader, keys) => {
    ...
    return Promise.reject("Failed to find the 'kid' specified in the id_token. 'kid' found in the header : " +
        headerJSON.kid +
        ", Expected values: " +
 ...
 */
export const isValidIdToken = (idToken, jwk, clientID, issuer, username, clockTolerance) => {
