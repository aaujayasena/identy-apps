...
import { ACCESS_TOKEN, ACCESS_TOKEN_EXPIRE_IN, ACCESS_TOKEN_ISSUED_AT, DISPLAY_NAME, EMAIL, ID_TOKEN, REFRESH_TOKEN, REFRESH_TOKEN_TIMER, REQUEST_PARAMS, SCOPE, SESSION_STATE, Storage, TENANT_DOMAIN, TOKEN_TYPE, USERNAME } from "../constants";
/**
 ...
 * @param {string} key.
 */
export function removeSessionParameter(key, requestParams) {
 ...
 * @param value value.
 */
export function setSessionParameter(key, value, requestParams) {
    switch (requestParams.storage) {
        case Storage.WebWorker:
 ...
 */
export function getSessionParameter(key, requestParams) {
    var _a;
    switch (requestParams.storage) {
        case Storage.WebWorker:
            return (_a = requestParams === null || requestParams === void 0 ? void 0 : requestParams.session) === null || _a === void 0 ? void 0 : _a.get(key);
        case Storage.SessionStorage:
 ...
 */
export function endAuthenticatedSession(requestParams) {
 ...
 */
export function initUserSession(tokenResponse, authenticatedUser, requestParams) {
 ...
 */
export function getAllSessionParameters(requestParams) {
    return {
 ...
 */
export function getAccessToken(requestParams) {
 ...
 */
const refreshTokenAutomatically = (config) => {
 ...
 * @param {ConfigInterface | WebWorkerConfigInterface} config - The init config.
 */
const clearRefreshTokenTimer = (config) => {
