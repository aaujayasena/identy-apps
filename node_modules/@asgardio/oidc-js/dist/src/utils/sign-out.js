...
import { ID_TOKEN, LOGOUT_SUCCESS, SIGN_OUT_REDIRECT_URL } from "../constants";
...
export function sendSignOutRequest(requestParams) {
    ...
    const logoutCallback = `${logoutEndpoint}?` + `id_token_hint=${idToken}` + `&post_logout_redirect_uri=${callbackURL}&state=`
        + LOGOUT_SUCCESS;
 ...
 */
/* eslint-disable @typescript-eslint/no-explicit-any */
export function handleSignOut(requestParams) {
    var _a;
    ...
    else if (isWebWorkerConfig(requestParams) && ((_a = requestParams === null || requestParams === void 0 ? void 0 : requestParams.session) === null || _a === void 0 ? void 0 : _a.size) === 0) {
        return Promise.reject(new Error("No login sessions."));
    }
    else {
