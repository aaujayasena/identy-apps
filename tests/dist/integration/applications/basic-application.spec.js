...
describe("ITC-2.0.0 - [applications] - Basic Applications Integration.", function () {
    var applicationsListPage = new ApplicationsListPage();
    var applicationTemplatesPage = new ApplicationTemplatesPage();
    var applicationEditPage = new ApplicationEditPage();
    var appName = "App - " + uuidv4();
    var redirectURL = "https://localhost:9000/sample-app/login";
    var accessURL = "https://localhost:9000/sample-app";
    var appImage = "https://seeklogo.com/images/O/openid-logo-8AD782234D-seeklogo.com.png";
    var jwksURL = "https://localhost:9443/oauth2/jwks";
    before(function () {
    ...
    context("ITC-2.1.0 - [applications] - Create an Application using the wizard.", function () {
        it("ITC-2.1.1 - [applications] - Register the Application.", function () {
        ...
        it("ITC-2.1.2 - [applications] - Correctly navigates to the edit page.", function () {
            cy.url().should("include", ApplicationEditPageConstants.PAGE_URL_MATCHER);
        });
    });
    context("ITC-2.2.0 - [applications] - Application edit page works as expected.", function () {
        it("ITC-2.2.1 - [applications] - Correctly renders the required elements of the edit page.", function () {
        ...
        it("ITC-2.2.2 - [applications] - Can navigate to all the tabs.", function () {
    ...
    context("ITC-2.3.0 - [applications] - Application General Settings.", function () {
        before(function () {
            applicationEditPage.selectTab("GENERAL");
        });
        it("ITC-2.3.1 - [applications] - Can edit basic settings.", function () {
        ...
        it.skip("ITC-2.3.2 - [applications] - Should not show certificate preview when an invalid PEM is entered.", function () {
        ...
        // This test case only fails during the product build time, but passes when it run locally.
        // Therefore skipping this test temporally until we find the cause for this failure.
        it.skip("ITC-2.3.3 - [applications] - Can provide a valid certificate file and preview it.", function () {
            applicationEditPage.getCustomCertRadio().click({ force: true, multiple: true });
    ...
    // This test case only fails during the product build time, but passes when it run locally.
    // Therefore skipping this test temporally until we find the cause for this failure.
    context.skip("ITC-2.4.0 - [applications] - Application Access Settings.", function () {
        before(function () {
            applicationEditPage.selectTab("ACCESS");
        });
        it("ITC-2.4.1 - [applications] - Content renders properly.", function () {
    ...
    // This test case only fails during the product build time, but passes when it run locally.
    // Therefore skipping this test temporally until we find the cause for this failure.
    context.skip("ITC-2.5.0 - [applications] - Application Attributes Configurations.", function () {
        before(function () {
            applicationEditPage.selectTab("ATTRIBUTES");
        });
        it("ITC-2.5.1 - [applications] - Content renders properly.", function () {
    ...
    // This test case only fails during the product build time, but passes when it run locally.
    // Therefore skipping this test temporally until we find the cause for this failure.
    context.skip("ITC-2.6.0 - [applications] - Delete Application using Danger Zone.", function () {
        before(function () {
            applicationEditPage.selectTab("GENERAL");
        });
        // This test case only fails during the product build time, but passes when it run locally.
        // Therefore skipping this test temporally until we find the cause for this failure.
        it.skip("ITC-2.6.1 - [applications] - Delete button is disabled when the assertion input is empty.", function () {
        ...
        it("ITC-2.6.2 - [applications] - Delete button is disabled when a wrong assertion is entered.", function () {
            applicationEditPage.getDangerZoneDeleteButton().click();
        ...
        // This test case only fails during the product build time, but passes when it run locally.
        // Therefore skipping this test temporally until we find the cause for this failure.
        it.skip("ITC-2.6.3 - [applications] - Can delete the application using the correct assertion is entered.", function () {
            applicationEditPage.getDangerZoneDeleteButton().click();
