...
describe("ITC-1.0.0 - [applications] - Applications Smoke Test.", function () {
    ...
    context("ITC-1.1.0 - [applications] - Applications Listing Page.", function () {
        it("ITC-1.1.1 - [applications] - User can visit applications listing page from the side panel", function () {
            cy.navigateToApplicationsList(true, false);
        });
        it("ITC-1.1.2 - [applications] - Properly renders the elements of the listing page.", function () {
            cy.checkIfApplicationsListingRenders();
        });
        it("ITC-1.1.3 - [applications] - There exists at-least one application on the list.", function () {
        ...
        it("ITC-1.1.4 - [applications] - Table rows renders properly.", function () {
            ...
            applicationsListPage.getTableBody()
                ...
                cy.wrap(row)
                    .find(CommonUtils.resolveDataTestId(ApplicationsListPageConstants.TABLE_ROW_IMAGE_DATA_ATTR))
                    .should("exist");
                // Check if heading exist.
                cy.wrap(row)
                    .find(CommonUtils.resolveDataTestId(ApplicationsListPageConstants.TABLE_ROW_HEADING_DATA_ATTR))
                    .should("exist");
                // Check if edit button exist.
                cy.wrap(row)
                    .find(CommonUtils.resolveDataTestId(ApplicationsListPageConstants.TABLE_ROW_EDIT_BUTTON_DATA_ATTR))
                    .should("exist");
            });
        });
    });
    context("ITC-1.2.0 - [applications] - Application Templates Page.", function () {
        it("ITC-1.2.1 - [applications] - Navigates to the template selection page properly.", function () {
        ...
        it.skip("ITC-1.2.2 - [applications] - Displays the template selection page elements properly.", function () {
