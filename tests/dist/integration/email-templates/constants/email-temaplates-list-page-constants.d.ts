 ...
 */
export declare class EmailTemplatesListPageConstants {
    /**
    ...
    static readonly TABLE_ROW_VIEW_BUTTON_DATA_ATTR: string;
    ...
    static readonly TEMPLATE_VIEW_MODAL_DATA_ATTR: string;
    static readonly TEMPLATE_VIEW_MODAL_CANCEL_BUTTON_DATA_ATTR: string;
}
