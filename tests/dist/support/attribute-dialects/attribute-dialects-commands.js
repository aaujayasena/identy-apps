 ...
 */
Cypress.Commands.add("navigateToAttributeDialectsList", function (switchPortalTab) {
    if (switchPortalTab === void 0) { switchPortalTab = true; }
    if (switchPortalTab) {
        var header = new Header();
        header.clickOnManagePortalSwitch();
    }
    var attributeDialectsListPage = new AttributeDialectsListPage();
 ...
 * @returns {Cypress.CanReturnChainable}
 */
Cypress.Commands.add("checkIfAttributeDialectsListingRenders", function (isNew) {
