 ...
 */
Cypress.Commands.add("checkIfElementExists", function (element, waitTime) {
 ...
 */
Cypress.Commands.add("recursiveEachChild", function ($element) {
 ...
 */
Cypress.Commands.add("isUrlValid", function (userInput) {
 ...
 * @param  {} noUsers
 */
Cypress.Commands.add("CreateUsersData", function (ScenarioNo, noUsers) {
    var testData = {
        users: []
    };
    if (noUsers > 0) {
 ...
 * @param  {} fixturesFile
 */
Cypress.Commands.add("createUserWithGivenFixtureData", function (url, authrzUserName, authrzPassword, fixturesFile, failOnStatusCode) {
 ...
 * @param  {} userInfor
 */
Cypress.Commands.add("createUser", function (url, authrzUserName, authrzPassword, userInfor, failOnStatusCode) {
    return cy.request({
        "method": "POST",
        "url": url,
        "failOnStatusCode": failOnStatusCode,
 ...
 * @param  {} userId
 */
Cypress.Commands.add("deleteUser", function (url, authrzUserName, authrzPassword, userId, failOnStatusCode) {
    return cy.request({
        method: "DELETE",
        url: url + userId,
        failOnStatusCode: failOnStatusCode,
 ...
 * @param  {} paramters
 */
Cypress.Commands.add("filterUser", function (url, authrzUserName, authrzPassword, paramters, failOnStatusCode) {
    if ("id" in paramters) {
 ...
 */
Cypress.Commands.add("getUserFromUserId", function (url, authrzUserName, authrzPassword, userId, failOnStatusCode) {
    return cy.request({
        method: "GET",
        url: url + userId,
        failOnStatusCode: failOnStatusCode,
 ...
 * @param  {} failOnStatusCode
 */
Cypress.Commands.add("patchUser", function (url, authrzUserName, authrzPassword, operations, userId, failOnStatusCode) {
 ...
 * @param  {} failOnStatusCode
 */
Cypress.Commands.add("patchUser", function (url, authrzUserName, authrzPassword, userInfor, failOnStatusCode) {
    return cy.request({
        method: "PUT",
 ...
 */
Cypress.Commands.add("patchUserWithGivenFixtureData", function (url, authrzUserName, authrzPassword, userId, failOnStatusCode, fixturesFileData) {
 ...
 * @param  {} failOnStatusCode
 */
Cypress.Commands.add("searchUser", function (url, authrzUserName, authrzPassword, searchParam, failOnStatusCode) {
 ...
 * @param  {} userInfor
 */
Cypress.Commands.add("createUserInBulk", function (url, authrzUserName, authrzPassword, failCount, failOnStatusCode, userInfor) {
    //Generate operations
    var operations = "[";
    var operaStr;
 ...
 * @param  {} fixturesFile
 */
Cypress.Commands.add("createUserInBulkWithGivenFixctureData", function (url, authrzUserName, authrzPassword, failOnStatusCode, fixturesFile) {
    cy.fixture(fixturesFile).as("reqBody");
    cy.get("@reqBody").then(function (reqBody) {
        return cy.request({
            "method": "POST",
            "url": url,
            "failOnStatusCode": failOnStatusCode,
 ...
 * @param  {} failCount
 */
Cypress.Commands.add("deleteUserInBulk", function (url, authrzUserName, authrzPassword, failOnStatusCode, userIds, failCount) {
    //Generate operations
    var operations = "[";
    var operaStr;
 ...
 */
Cypress.Commands.add("saveLocalStorageCache", function () {
 ...
 * To prevent the clearing of the local storage.
 */
Cypress.Commands.add("restoreLocalStorageCache", function () {
