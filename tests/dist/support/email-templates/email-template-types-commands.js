 ...
 */
Cypress.Commands.add("navigateToEmailTemplateTypes", function (switchPortalTab, assertIfRenders) {
 ...
 * @returns {Cypress.CanReturnChainable}
 */
Cypress.Commands.add("checkIfEmailTemplateTypeListingRenders", function () {
    var emailTemplateTypesListPage = new EmailTemplateTypesListPage();
