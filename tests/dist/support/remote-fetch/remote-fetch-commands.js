 ...
 */
Cypress.Commands.add("navigateToRemoteFetchPage", function (switchPortalTab) {
    if (switchPortalTab === void 0) { switchPortalTab = true; }
    if (switchPortalTab) {
        var header = new Header();
        header.clickOnManagePortalSwitch();
    }
    var remoteFetchConfigurationPage = new RemoteConfigurationPage();
 ...
 * @returns {Cypress.CanReturnChainable}
 */
Cypress.Commands.add("checkIfRemoteFetchPageRenders", function () {
    var remoteFetchConfigurationPage = new RemoteConfigurationPage();
